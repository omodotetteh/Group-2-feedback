...
function Solution() {
  ...
  const [activeItem, setActiveItem] = useState('solution');
        ...
        <div className="flex-1 overflow-y-auto p-4 lg:p-8">
          ...
          >
            ☰
              ...
              <h2 className="text-lg font-semibold text-gray-800 flex justify-center text-center -mt-7">Business Solution Feedback</h2>
            </div>
